...
import { CloseIcon, UploadIcon, DownloadIcon, BowIcon, DeleteIcon, InfoIcon } from './icons';
            ...
            >
                <div className="flex justify-between items-center mb-4">
                    <h2 id="settings-title" className="text-lg font-bold text-primary">
                        {showCredits ? 'Credits' : 'Einstellungen'}
                    </h2>
                    <button
                        onClick={() => {
                        ...
                        aria-label={showCredits ? "Zurück zu Einstellungen" : "Einstellungen schließen"}
                    >
                        {showCredits ? (
                    ...
                    <div className="space-y-6">
                        <div className="space-y-4">
                            <div className="bg-surface-light p-4 rounded-lg">
                                <h3 className="text-sm font-medium text-secondary mb-2">Favicon / PWA Icon</h3>
                                <a
                                ...
                                >
                                    <span>Book icons created by Smashicons - Flaticon</span>
                                    <span className="material-symbols-outlined text-sm">open_in_new</span>
                                </a>
                            </div>

                            <div className="bg-surface-light p-4 rounded-lg">
                                <h3 className="text-sm font-medium text-secondary mb-2">Globale Schriftart</h3>
                                <p className="text-primary">Ubuntu</p>
                            </div>

                            <div className="bg-surface-light p-4 rounded-lg">
                                <h3 className="text-sm font-medium text-secondary mb-2">Sonstige Symbole</h3>
                                <p className="text-primary">Google Fonts Icons (Material Symbols)</p>
                            </div>

                            <div className="bg-surface-light p-4 rounded-lg">
                                <h3 className="text-sm font-medium text-secondary mb-2">Entwicklung</h3>
                                <p className="text-primary">
                                    Gesamte Webseite Erstellung: <span className="font-semibold text-accent">Vibe Coding</span> mit <span className="font-semibold text-accent">Gemini AI</span>
                                </p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="mt-8 pt-6 border-t border-border">
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                ...
                                <button
                                    ...
                                    className="flex flex-col items-center justify-center text-center p-4 rounded-lg bg-surface-light hover:bg-border transition-colors aspect-square"
                                >
                                    <InfoIcon className="w-7 h-7 mb-2 text-blue-400" />
                                    <span className="text-primary text-sm font-normal">Credits</span>
                                </button>
                            </div>
                        </div>
